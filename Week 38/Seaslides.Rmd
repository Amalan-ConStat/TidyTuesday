...
knitr::opts_chunk$set(echo = FALSE,message = FALSE,include = FALSE,warning = FALSE)
```
...
```{r Load the data,include=TRUE,echo=TRUE}
#load the data
...
```{r Code Snippet 1,include=TRUE,echo=TRUE,fig.show=FALSE}
...
```{r Code Snippet 2,include=TRUE,echo=TRUE,fig.show=FALSE}
...
```{r Code Snippet 3,include=TRUE,echo=TRUE,fig.show=FALSE}
...
```{r Code Snippet 4,include=TRUE,echo=TRUE,fig.show=FALSE}
...
```{r Code Snippet 5,include=TRUE,echo=TRUE,fig.show=FALSE}
...
```{r Code Snippet 6,include=TRUE,echo=TRUE,fig.show=FALSE}
